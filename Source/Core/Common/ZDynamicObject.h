...
namespace PaintsNow {
	...
	class ZDynamicObject : public IReflectObjectComplex {
	public:
	...
	class ZDynamicVector : public IReflectObjectComplex {
	public:
	...
	class ZDynamicObjectWrapper : public IReflectObjectComplex {
	public:
