...
namespace PaintsNow {
	namespace NsLeavesWing {
		...
		public:
			...
			virtual void RegisterRuntimeHook(const TWrapper<void, NsLeavesWind::LeavesWind*, RUNTIME_STATE>& proc);
			virtual void WriteString(String& target, const String& source) const;

			void PostRuntimeState(NsLeavesWind::LeavesWind* leavesWind, RUNTIME_STATE state);
		...
		private:
			...
			std::vector<TWrapper<void, NsLeavesWind::LeavesWind*, RUNTIME_STATE> > runtimeHooks;
		};
	}
}
