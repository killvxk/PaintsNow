...
void ZScriptTCC::Request::Debug(std::vector<StackInfo>& debugInfos, std::vector<LocalInfo>& localInfos, const Ref* func) {
...
IScript::Request& ZScriptTCC::Request::operator << (const LocalInfo& k) {
	assert(GetScript()->GetLockCount() != 0);
	return *this;
}
...
void ZScriptTCC::Request::DebugPrint() {}
...
IScript::Request::Ref ZScriptTCC::Request::ReferenceWithDebugInfo(const BaseDelegate& d, const String& tag, int line) {
	return IScript::Request::Ref();
}

IScript::Request::Ref ZScriptTCC::Request::ReferenceWithDebugInfo(const Ref& d, const String& tag, int line) {
	return IScript::Request::Ref();
}

IScript::Request::Ref ZScriptTCC::Request::ReferenceWithDebugInfo(const LocalInfo& d, const String& tag, int line) {
	return IScript::Request::Ref();
}
