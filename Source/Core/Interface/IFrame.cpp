...
IFrame::EventMouse::EventMouse(bool d, bool m, bool l, bool w, const ZInt2& p) : down(d), move(m), left(l), wheel(w), position(p) {}
...
const char* IFrame::EventKeyboard::GetName() const {
	...
	if (!!(key & KEY_SPECIAL)) {
		static const char* specialMap[] = {
			"nullptr", "F1", "F2", "F3", "F4", "F5", "F6", "F7", "F8", "F9", "F10", "F11", "F12", "LEFT", "UP", "RIGHT", "DOWN", "PAGEUP", "PAGEDOWN", "HOME", "END", "INSERT", "DELETE", "NUM_LOCK", "BEGIN"
		};
		...
		static const char* charMap[] = {
			"nullptr", "SOH", "STX", "ETX", "EOT", "ENQ", "ACK", "BEL",
