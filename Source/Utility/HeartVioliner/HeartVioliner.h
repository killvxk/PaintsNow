...
namespace PaintsNow {
	namespace NsHeartVioliner {
		class HeartVioliner : public IScript::Library {
		public:
		...
		protected:
			...
			void RequestCreateClock(IScript::Request& request, int64_t interval, int64_t start);
			...
			void RequestCreateQueue(IScript::Request& request);
